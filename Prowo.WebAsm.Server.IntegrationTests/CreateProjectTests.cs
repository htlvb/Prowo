...
public class CreateProjectTests
{
    ...
    public async Task CanCreateProjectAsOrganizerWhenAuthorized()
    {
        ...
        var isProjectValid = Project.TryCreateFromEditingProjectDataDto(project, actualNewProjects[0].Id, FakeData.DefaultEvent, FakeData.ProjectOrganizers.ToDictionary(v => v.Id), timeProvider, null, out var expectedNewProject, out _);
