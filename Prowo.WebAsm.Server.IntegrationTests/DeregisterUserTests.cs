...
public class CustomGenerators
{
    ...
    public static Arbitrary<StartTime> EndTimeGenerator(StartTime startTime)
    {
    ...
    public static Arbitrary<ClosingDate> ClosingDateGenerator(DateOnly projectDate)
    {
        var gen =
            ...
            let date = DateTime.Today.AddMinutes(-offsetMinutes)
...
public class DeregisterUserTests
{
    ...
    public async Task CantDeregisterUserWhenNotAuthenticated(FutureProjectWithAttendees p, NonNegativeInt removeAt)
    {
